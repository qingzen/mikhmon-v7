...
// get variable
  ...
  $removereportid = $_GET['remove-report-id'];
...
// enable hotspot user
  ...
  elseif ($removereportid != "") {
    echo "<b class='cl-w'><i class='fa fa-circle-o-notch fa-spin' style='font-size:24px'></i> Processing...</b>";

    include_once('./process/removereportid.php');
  }
...
// netwatch
elseif ($netwatch == "netws" || $netwatch == "netwp" || $netwatch == "netwa") {
  include_once('./netwatch/netws.php');
}
...
elseif ($removenetw != "") {
  ...
  include_once('./process/removenetw.php');
}
